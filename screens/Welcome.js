        ...
        <Block
          ...
          <ScrollView style={{marginVertical: theme.sizes.padding}}>
            ...
            <Text
              ...
              height={24}
              style={{marginBottom: theme.sizes.base}}>
              3. You understand that third-party vendors and hosting partners to
          ...
          <Block middle padding={[theme.sizes.base / 2, 0]}>
            <Button shadow onPress={() => this.setState({showTerms: false})}>
    ...
    return (
      <Block>
        <Block center bottom flex={0.4}>
          ...
          <Text h2 gray style={{marginTop: theme.sizes.padding / 2}}>
